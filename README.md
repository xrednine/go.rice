...
[![Godoc](https://img.shields.io/badge/godoc-go.rice-blue.svg?style=flat-square)](https://godoc.org/github.com/xrednine/go.rice)
...
```bash
go get github.com/xrednine/go.rice
go get github.com/xrednine/go.rice/rice
```

## Package usage

Import the package: `import "github.com/xrednine/go.rice"`
...
You will find package documentation at [godoc.org/github.com/xrednine/go.rice][godoc].

[license]: https://github.com/xrednine/go.rice/blob/master/LICENSE
[godoc]: http://godoc.org/github.com/xrednine/go.rice
